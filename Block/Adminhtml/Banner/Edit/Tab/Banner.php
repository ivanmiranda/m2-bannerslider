...
namespace Pengo\Bannerslider\Block\Adminhtml\Banner\Edit\Tab;
...
class Banner extends \Magento\Backend\Block\Widget\Form\Generic implements \Magento\Backend\Block\Widget\Tab\TabInterface
{
    ...
    /**
     * @var \Pengo\Bannerslider\Model\Banner
     */
    protected $_banner;
    ...
    public function __construct(
        ...
        \Pengo\Bannerslider\Model\Banner $banner,
    ...
    protected function _prepareLayout()
    {
        ...
        \Magento\Framework\Data\Form::setFieldsetElementRenderer(
            $this->getLayout()->createBlock(
                'Pengo\Bannerslider\Block\Adminhtml\Form\Renderer\Fieldset\Element',
    ...
    protected function _prepareForm()
    {
        ...
        $elements['sku'] = $fieldset->addField(
            'sku',
            'text',
            [
                'title' => __('SKU Product'),
        ...
        $elements['target'] = $fieldset->addField(
            ...
            [
                ...
                'values' => [
                    [
                        'value' => \Pengo\Bannerslider\Model\Banner::BANNER_TARGET_SELF,
                        'label' => __('Self Window'),
                    ],
                    [
                        'value' => \Pengo\Bannerslider\Model\Banner::BANNER_TARGET_PARENT,
                        'label' => __('Parent Window'),
                    ],
                    [
                        'value' => \Pengo\Bannerslider\Model\Banner::BANNER_TARGET_BLANK,
                        'label' => __('New Window'),
                    ],
                ],
            ]
