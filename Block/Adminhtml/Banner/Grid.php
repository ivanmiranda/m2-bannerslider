...
namespace Pengo\Bannerslider\Block\Adminhtml\Banner;
...
class Grid extends \Magento\Backend\Block\Widget\Grid\Extended
{
    ...
    protected function _prepareCollection()
    {
        ...
        /** @var \Pengo\Bannerslider\Model\ResourceModel\Banner\Collection $collection */
    ...
    protected function _prepareColumns()
    {
        ...
        $this->addColumn(
            ...
            [
                ...
                'width' => '50px',
                'filter' => false,
                'renderer' => 'Pengo\Bannerslider\Block\Adminhtml\Banner\Helper\Renderer\Image',
            ]
        );
        $this->addColumn(
            'click_url',
