...
class Bannerslider extends \Magento\Framework\View\Element\Template
{
     ...
     * @var string
     */
    protected $_template = 'Pengo_Bannerslider::bannerslider.phtml';
     ...
     *
     * @param \Pengo\Bannerslider\Model\ResourceModel\Slider\Collection $sliderCollection [description]
     *
     * @return \Pengo\Bannerslider\Block\Bannerslider [description]
     */
    public function appendChildBlockSliders(
        \Pengo\Bannerslider\Model\ResourceModel\Slider\Collection $sliderCollection
    ) {
        foreach ($sliderCollection as $slider) {
            $this->append(
                $this->getLayout()->createBlock(
                    'Pengo\Bannerslider\Block\SliderItem'
