 ...
 * @author   @deivanmiranda
 */
class ExportXml extends \Pengo\Bannerslider\Controller\Adminhtml\Banner
{
    public function execute()
    {
        ...
        $content = $resultPage->getLayout()->createBlock('Pengo\Bannerslider\Block\Adminhtml\Banner\Grid')->getXml();
