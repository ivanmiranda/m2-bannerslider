 ...
 * @author   @deivanmiranda
 */
class Save extends \Pengo\Bannerslider\Controller\Adminhtml\Banner
{
    /**
            ...
            if ($imageRequest && strlen($fileName)) {
                ...
                try {
                    ...
                    $result = $uploader->save(
                        $mediaDirectory->getAbsolutePath(\Pengo\Bannerslider\Model\Banner::BASE_MEDIA_PATH)
                    );
                    $data['image'] = \Pengo\Bannerslider\Model\Banner::BASE_MEDIA_PATH.$result['file'];
                } catch (\Exception $e) {
                    if ($e->getCode() == 0) {
