 ...
 * @author   @deivanmiranda
 */
abstract class CoreSlider extends \Pengo\Bannerslider\Controller\Adminhtml\AbstractAction
{
    /**
    ...
    {
        return $this->_authorization->isAllowed('Pengo_Bannerslider::bannerslider_coreslider');
    }
}
