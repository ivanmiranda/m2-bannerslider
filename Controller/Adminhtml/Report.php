 ...
 * @author   @deivanmiranda
 */
abstract class Report extends \Pengo\Bannerslider\Controller\Adminhtml\AbstractAction
{
    /**
    ...
    {
        return $this->_authorization->isAllowed('Pengo_Bannerslider::bannerslider_reports');
    }
}
