 ...
 * @author   @deivanmiranda
 */
class ExportXml extends \Pengo\Bannerslider\Controller\Adminhtml\Report
{
    public function execute()
    {
        ...
        $content = $resultPage->getLayout()->createBlock('Pengo\Bannerslider\Block\Adminhtml\Report\Grid')->getXml();
