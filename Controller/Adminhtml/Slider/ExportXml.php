 ...
 * @author   @deivanmiranda
 */
class ExportXml extends \Pengo\Bannerslider\Controller\Adminhtml\Slider
{
    public function execute()
    {
        ...
        $content = $resultPage->getLayout()->createBlock('Pengo\Bannerslider\Block\Adminhtml\Slider\Grid')->getXml();
