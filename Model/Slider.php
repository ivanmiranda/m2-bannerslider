...
class Slider extends \Magento\Framework\Model\AbstractModel
{
     ...
     * vertical
     */
    const STYLESLIDE_VERTICAL_ONE = 11;
    const STYLESLIDE_VERTICAL_TWO = 12;
    const STYLESLIDE_VERTICAL_THREE = 13;
     ...
     * @param \Pengo\Bannerslider\Model\ResourceModel\Slider                   $resource
     * @param \Pengo\Bannerslider\Model\ResourceModel\Slider\Collection        $resourceCollection
     */
    public function __construct(
        \Magento\Framework\Model\Context $context,
        \Magento\Framework\Registry $registry,
        \Pengo\Bannerslider\Model\ResourceModel\Banner\CollectionFactory $bannerCollectionFactory,
        \Pengo\Bannerslider\Model\ResourceModel\Slider $resource,
        \Pengo\Bannerslider\Model\ResourceModel\Slider\Collection $resourceCollection
    ) {
        parent::__construct(
            $context,
            $registry,
